...
*/
var var1 = 1000;
let accountBalance = var1;
PostDecrement = --accountBalance;
console.log(`my account balance was ${var1}, before I walked to the park, after the park my account balance was ${PostDecrement}`)
...
var var2 = 20;
myAge = ++var2;
console.log(`Today is my birthday and I am ${myAge} years old`);
